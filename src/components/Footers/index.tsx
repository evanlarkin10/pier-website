...
export default function Footer({}: FooterProps) {
  return (
    <footer className="bg-primary">
      <div className="flex flex-col sm:flex-row justify-between p-10 gap-10 sm:gap-0">
        <div className="flex flex-col flex-[1] sm:border-r-2 sm:border-secondary px-10">
          <Text variant="h3" tag="span" additionalClasses="text-secondary">
            INN AT THE PIER
          </Text>
      ...
      {/* https://www.facebook.com/InnatthePier/ */}
      {/* https://www.instagram.com/innatthepier */}
